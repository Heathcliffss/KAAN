...
public class AirplaneController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //hÄ±zÄ± 60 dan bÃ¼yÃ¼r ise arttÄ±rma (savrulmamasÄ± iÃ§in)
       /* if(rb.linearVelocity.magnitude > 45)
        ...
        if (Gamepad.current != null)
        {
            R2 = Gamepad.current.rightTrigger.ReadValue(); // 0-1 arasÄ±
            L2 = Gamepad.current.leftTrigger.ReadValue();  // 0-1 arasÄ±
        }
